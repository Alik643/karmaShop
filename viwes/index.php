                    ...
                    <div class="row single-slide align-items-center d-flex">
                        <div class="col-lg-5 col-md-6">
                            <div class="banner-content">
                                ...
                                <div class="add-bag d-flex align-items-center">
                                    <a class="add-btn addToBag" data-id="<?=$item['id']?>" href="/"><span class="lnr lnr-cross"></span></a>
                        ...
                        <div class="col-lg-7">
                            <div class="banner-img">
                                <img class="img-fluid" src="/templates/img/upload/<?=$item['image']?>" alt="error">
                            </div>
                        </div>
                    </div>
                    <?endforeach;?>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-product">
						<img style="height: 170px; width: auto" class="img-fluid" src="/templates/img/upload/<?=$item['image']?>" alt="error">
						<div class="product-details">
							...
							<div class="prd-bottom">
								...
								<a data-id="<?=$item['id']?>" href="/bag/add/<?=$item['id']?>" class="social-info addToBag">
									<span class="ti-bag"></span>
									<p class="hover-text">add to bag</p>
								</a>
								<a href="/product/addWishList/<?=$item['id']?>" class="social-info">
	...
	<div class="single-product-slider">
		<div class="container">
			...
			<div class="row">
				...
				<?php
                if(!empty($productsSoon)):
                foreach ($productsSoon as $item):?>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="/templates/img/upload/<?=$item['image']?>" alt="error">
                            <div class="product-details">
                                ...
                                <div class="prd-bottom">
                                    ...
                                    <a href="/bag/add/<?=$item['id']?>" class="social-info">
                                        <span class="ti-bag"></span>
                                        <p class="hover-text">add to bag</p>
                                    </a>
                                    <a href="/wishList/add/<?=$item['id']?>" class="social-info">
                                        <span class="lnr lnr-heart"></span>
                                        <p class="hover-text">Wishlist</p>
                                    </a>
                                    <a href="" class="social-info">
			...
			<div class="col-lg-6 no-padding exclusive-right">
				<div class="active-exclusive-product-slider">
					...
					<div class="single-exclusive-slider">
						<img class="img-fluid" src="<?$_SERVER['DOCUMENT_ROOT']?>/templates/img/product/e-p1.png" alt="">
						<div class="product-details">
							<div class="price">
								<h6>$150.00</h6>
								<h6 class="l-through">$210.00</h6>
							...
							<div class="add-bag d-flex align-items-center justify-content-center">
								<a class="add-btn" href="/bag/add/<?=$item['id']?>"><span class="ti-bag"></span></a>
								<span class="add-text text-uppercase">Add to Bag</span>
							</div>
						</div>
					</div>
...
<style>
    .banner-area {
        background: url('/templates/img/aaa/banner-bg.jpg') center/cover !important;
    }
</style>

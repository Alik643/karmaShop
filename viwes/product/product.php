				...
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="/templates/img/upload/<?=$product['image']?>" alt="error">
						</div>
					</div>
				</div>
					...
					<div class="s_product_text">
                        ...
                        <form action="#">
                            ...
                            <div class="card_area d-flex align-items-center">
                                <a class="primary-btn addToBag" data-id="<?=$product['id']?>" href="/">Add to Cart</a>
                            </div>
                        </form>
					</div>
				</div>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5><?=$product['Freshness_Duration']?>mm</h5>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									...
									<td>
										<h5><?=$product['Each_Box_contains']?>pcs</h5>
									</td>
								</tr>
							</tbody>
						</table>
